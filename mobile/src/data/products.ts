...
export const PRODUCTS: Product[] = [
  ...
  return { ...p, ratio, image: img(p.tags, 400, Math.round(400 * ratio), 1000 + i) };
});

export function getProducts({ category = 'all', query = '', page = 1, perPage = 20 } = {}) {
...
export const EDITORIAL_STRIPS = [
  { title: 'Trending Now',  filter: (p: Product) => p.price > 80 },
